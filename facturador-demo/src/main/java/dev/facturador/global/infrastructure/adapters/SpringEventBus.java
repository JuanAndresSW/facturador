...
import dev.facturador.global.domain.abstractcomponents.event.EventBus;
import dev.facturador.global.domain.abstractcomponents.event.EventHandler;
...
public class SpringEventBus implements EventBus {
     ...
     */
    @Autowired
    public SpringEventBus(List<EventHandler> eventHandlers) {
