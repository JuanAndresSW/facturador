...
export default function Field(_a) {
    ...
    return (React.createElement("label", null, " ", label, React.createElement("span", null, " ", note), React.createElement("div", { className: validator ? "field-wrap" : "field-wrap invalid" }, icon !== undefined ? icon : null, React.createElement("input", { className: "field", placeholder: placeholder, type: type, value: bind[0] ? bind[0] : "", onChange: function (e) { return bind[1](e.target.value); } }))));
}
;
