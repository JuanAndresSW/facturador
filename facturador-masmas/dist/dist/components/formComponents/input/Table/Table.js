...
export default function Table(_a) {
    ...
    return (React.createElement(React.Fragment, null, React.createElement("legend", null, label), React.createElement("table", null, React.createElement("thead", null, React.createElement("tr", null, headers.map(function (header, index) {
        ...
        row.slice(0, headers.length).map(function (cell, colIndex) {
            ...
            React.createElement("td", { onClick: removeRow }, React.createElement(BsFileMinusFill, null)) : null);
    })), bind[0].length < maxRows ?
        React.createElement("tfoot", null, React.createElement("tr", null, headers.map(function (h, index) {
            return (index + 1 === headers.length) ?
                React.createElement("td", { key: h.th }, React.createElement(BsFillPlusSquareFill, { onClick: addRow }))
