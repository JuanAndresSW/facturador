...
export default function Account() {
    ...
    useEffect(function () {
        ...
        retrieveAccount(function (state, data) {
            ...
            setVatCategory(obj.vatCategory);
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        _d.label = 3;
                    case 3:
                        account = (_b.user = (_c.newAvatar = _a,
                            _c),
                            _b.trader = {
    ...
    /*FORMULARIO***************************************************************/
    return (React.createElement(React.Fragment, null, React.createElement(Form, { title: "Opciones de la cuenta", onSubmit: filter }, React.createElement(BiChevronLeft, { onClick: function () { return navigate("/inicio"); }, style: { margin: "1rem", fontSize: "2rem", color: "rgb(44,44,44)", cursor: "pointer" } }), React.createElement(Image, { label: '', setter: setAvatar, img: avatar }), React.createElement("h5", { style: { width: "min-content", margin: "0 auto", display: "block", fontSize: "1.2rem", color: "rgb(212, 212, 212)", cursor: "default" } }, email), React.createElement(Field, { bind: [newUsername, setNewUsername], label: "Nombre", placeholder: sessionStorage.getItem('username') }), React.createElement(Field, { bind: [password, setPassword], label: "Para cambiar tu contrase\u00F1a, introduce la contrase\u00F1a actual:", type: "password" }), !Valid.password(password) ? null :
        React.createElement(React.Fragment, null, React.createElement(Field, { bind: [newPassword, setNewPassword], label: "Nueva contrase\u00F1a", type: "password" }), React.createElement(Field, { bind: [confirmPassword, setConfirmPassword], label: "Confirmar nueva contrase\u00F1a", type: "password" })), !hasRootAccess ? null :
        React.createElement(Section, { label: "Datos del comercio" }, React.createElement(Field, { bind: [newBusinessName, setNewBusinessName], label: "Raz\u00F3n social", placeholder: businessName }), React.createElement(Radio, { legend: "Actualmente: " + vatCategory + ". Nueva categoría:", bind: [newVatCategory, setNewVatCategory], options: ["Responsable Inscripto", "Monotributista", "Sujeto Exento"] }), React.createElement(Field, { label: "C.U.I." + (newVatCategory === "Monotributista" ? "L. " : "T. "), bind: [newCode, setNewCode], placeholder: code })), React.createElement(ErrorMessage, { message: error }), loading ? React.createElement(Loading, null) :
        React.createElement(Button, { text: "Confirmar cambios", type: "submit" }), React.createElement("p", { style: { textAlign: "center", color: "#fff", cursor: "default" } }, "..."), React.createElement(Retractable, { label: "Otras opciones", initial: false }, !deletePermissionGranted ? null :
        React.createElement(Field, { bind: [deletionCode, setDeletionCode], label: "Se ha enviado a ".concat(email, " el c\u00F3digo de eliminaci\u00F3n. Escr\u00EDbelo a continuaci\u00F3n para confirmar:") }), React.createElement(ErrorMessage, { message: deleteError }), loading ? React.createElement(Loading, null) :
