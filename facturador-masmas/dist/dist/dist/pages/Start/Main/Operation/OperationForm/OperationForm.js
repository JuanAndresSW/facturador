...
export default function OperationForm(_a) {
    ...
    return (React.createElement(React.Fragment, null, React.createElement("form", { id: "form", method: "post", target: "_blank", className: "panel" }, React.createElement("h1", { className: "title" }, getTitle(type, flux)), React.createElement(SelectPartakers, { setter: setter, dataToShow: dataToShow, flux: flux }), React.createElement(Type, { type: type }), React.createElement(ProductTable, { type: type }), React.createElement(Observations, { type: type }), React.createElement(PurchaseExtra, { type: type }), React.createElement("button", null, "Generar"))));
}
