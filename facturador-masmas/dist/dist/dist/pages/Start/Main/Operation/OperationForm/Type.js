...
export default function PurchaseExtra(_a) {
    ...
    return (type === "invoice" || "credit-note" || "debit-note" ?
        React.createElement("div", null, true ? (React.createElement(React.Fragment, null, React.createElement("div", { className: "option" }), React.createElement("div", { className: "option" })))
