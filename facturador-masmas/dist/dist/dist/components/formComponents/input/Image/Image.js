...
export default function Image(_a) {
    ...
    return (React.createElement("label", { className: "image" }, label, React.createElement("span", null, " ", note), img ? React.createElement(BsFillXCircleFill, { onClick: function (e) { e.preventDefault(); setter(undefined); } }) : null, React.createElement("input", { type: "file", accept: ".png, .jpeg, .jpg, .svg", onChange: function (e) {
            if (e.target.files && e.target.files.length > 0)
                setter(e.target.files.item(0));
        } }), React.createElement("div", null, React.createElement("img", { src: img ? URL.createObjectURL(img) : fallback }))));
}
