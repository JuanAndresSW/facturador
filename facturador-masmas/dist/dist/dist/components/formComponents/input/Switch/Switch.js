...
export default function Switch(_a) {
    ...
    return (React.createElement("label", { className: "select", style: (label.length === 0) ? { margin: "0 auto" } : {} }, " ", label, " ", React.createElement("span", null, " ", note), React.createElement("div", { className: bind[0] ? "switch switch-true" : "switch switch-false", onClick: function () { return bind[1](!bind[0]); } }, falseIcon, trueIcon)));
}
;
