...
export default function Start() {
    return (React.createElement(React.Fragment, null, React.createElement(NotLoggedHeader, null), React.createElement(TitleScreen, null), React.createElement(Features, null), React.createElement(Phone, null), React.createElement(Footer, null)));
}
