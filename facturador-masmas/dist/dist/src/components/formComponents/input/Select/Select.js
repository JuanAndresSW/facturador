...
export default function Select(_a) {
    ...
    return (React.createElement("label", { className: "select", style: (label.length === 0) ? { margin: "0 auto" } : {} }, " ", label, React.createElement("select", { onChange: function (e) { return bind[1](e.target.value); }, value: bind[0] }, options.map(function (option) {
