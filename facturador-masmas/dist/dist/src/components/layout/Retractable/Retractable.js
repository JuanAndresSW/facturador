...
export default function Retractable(_a) {
    ...
    return (React.createElement("div", { className: extended ? "retractable" : "retractable folded" }, React.createElement("div", { onClick: change }, label, extended ? React.createElement(BiChevronUp, null) : React.createElement(BiChevronDown, null)), React.createElement("div", null, children)));
}
