...
export default function NewPoint() {
    ...
    ;
    return (React.createElement(Form, { title: "Crea un punto de venta" }, React.createElement(BiChevronLeft, { onClick: function () { return navigate(-1); }, style: { margin: "1rem", fontSize: "2rem", color: "rgb(44,44,44)", cursor: "pointer" } }), React.createElement(Field, { label: "Nombre del comercio", bind: [name, setName], placeholder: "Entre 3 y 20 caracteres" }), React.createElement(Retractable, { label: "Direcci\u00F3n", sync: boolAddress, onClick: function (state) { setBoolAddress(state); setBoolContact(false); setBoolPreferences(false); } }, React.createElement(Select, { label: "Provincia", bind: [province, setProvince], options: provinces }), React.createElement(Field, { label: "Departamento", bind: [department, setDepartment] }), React.createElement(Field, { label: "Localidad", bind: [locality, setLocality] }), React.createElement(Field, { label: "C\u00F3digo postal", bind: [postalCode, setPostalCode], type: "number" }), React.createElement(Field, { label: "Calle", bind: [street, setStreet] }), React.createElement(Field, { label: "N\u00FAmero de direcci\u00F3n", bind: [number, setNumber], type: "number" })), React.createElement(Retractable, { label: "Informaci\u00F3n de contacto", sync: boolContact, onClick: function (state) { setBoolContact(state); setBoolAddress(false); setBoolPreferences(false); } }, React.createElement(Field, { label: "Correo electr\u00F3nico", note: "(opcional)", bind: [email, setEmail], type: "email" }), React.createElement(Field, { label: "N\u00FAmero de tel\u00E9fono", note: "(opcional)", bind: [phone, setPhone], type: "tel" }), React.createElement(Field, { label: "Sitio web", note: "(opcional)", bind: [website, setWebsite], type: "url" })), React.createElement(Retractable, { label: "Personalizaci\u00F3n", sync: boolPreferences, onClick: function (state) { setBoolPreferences(state); setBoolAddress(false); setBoolContact(false); } }, React.createElement(Image, { label: "Logo", note: "(opcional)", img: logo, setter: setLogo, fallback: defaultLogo }), React.createElement(Color, { label: "Color de los documentos comerciales", value: color, onChange: setColor })), React.createElement(ErrorMessage, { message: error }), React.createElement(Button, { text: "Crear", type: "submit" })));
}
var provinces = [
