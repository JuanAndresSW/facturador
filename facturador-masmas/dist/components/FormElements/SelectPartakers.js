...
export default function SelectPartakers(_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "form-section" },
            React.createElement(Dropdown, { label: "Punto de venta", content: (_b = dataToShow.partakers) === null || _b === void 0 ? void 0 : _b.pointsOfSale, link: React.createElement(Link, { to: "/puntos-de-venta" }, "Nuevo punto de venta"), current: dataToShow.currentPoint, setter: setter.setPointOfSale, allow1OrLess: false }),
            ...
            React.createElement(Dropdown, { label: "Terceros", content: (_d = dataToShow.partakers) === null || _d === void 0 ? void 0 : _d.partners, link: React.createElement(Link, { to: "/puntos-de-venta" }, "Nuevo socio"), current: dataToShow.currentPartner, setter: setter.setPartner, allow1OrLess: true }))));
}
