...
export default function Dropdown(_a) {
    ...
    return ((content === undefined || current === null) ? React.createElement(React.Fragment, null, "Cargando...") :
        (!allow1OrLess && content.length < 2) ? React.createElement("div", null, current.name + ': ' + current.address) :
            React.createElement("label", null,
                " ",
                label,
                React.createElement(OutsideClickHandler, { onOutsideClick: function () { return setController(false); } },
                    React.createElement("div", { className: "wrapper" },
                        React.createElement("div", { className: "dropdown", onClick: function () { return setController(!controller); } },
                            React.createElement("div", null,
                                React.createElement("h3", null, current.name),
                                React.createElement("p", null, current.address)),
                            controller ? React.createElement(BiCaretUp, null) : React.createElement(BiCaretDown, null)),
                        React.createElement("div", { className: controller ? "drop-content" : 'drop-content disable' },
                            content.length > 10 ?
                                React.createElement("input", { type: "search", placeholder: "Buscar por direcci\u00F3n" }) : React.createElement(React.Fragment, null),
                            content.map(function (option, index) { return (React.createElement("div", { key: index, onClick: function () {
                                    setter(option);
                                    setController(false);
