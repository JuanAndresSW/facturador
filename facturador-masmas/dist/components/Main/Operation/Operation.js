...
export default function Transaction() {
    return (React.createElement(Routes, null,
        ...
        React.createElement(Route, { path: "/enviar/*", element: React.createElement(OperationTypes, { flux: "out" }) }),
        React.createElement(Route, { path: "/recibir/*", element: React.createElement(OperationTypes, { flux: "in" }) }),
