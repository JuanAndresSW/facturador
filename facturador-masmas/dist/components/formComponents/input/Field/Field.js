...
export default function Field(_a) {
    var _b = _a.label, label = _b === void 0 ? "" : _b, icon = _a.icon, note = _a.note, _c = _a.type, type = _c === void 0 ? "text" : _c, bind = _a.bind, _d = _a.validator, validator = _d === void 0 ? true : _d;
