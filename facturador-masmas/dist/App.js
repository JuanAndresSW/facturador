        ...
        React.createElement(BrowserRouter, null,
            React.createElement(Suspense, { fallback: React.createElement(FallBack, null) },
                React.createElement(Routes, null,
                    React.createElement(Route, { path: "/*", element: React.createElement(Protected, { reverse: true },
                            React.createElement(Home, null)) }),
                    React.createElement(Route, { path: "/login", element: React.createElement(Protected, { reverse: true },
                            React.createElement(Login, null)) }),
                    React.createElement(Route, { path: "/cuenta/*", element: React.createElement(Protected, null,
                            React.createElement(Account, null)) }),
                    React.createElement(Route, { path: "/inicio/*", element: React.createElement(Protected, null,
