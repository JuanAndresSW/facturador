...
export default function App() {
    ...
    useEffect(function () { return getSessionByToken(function (ok) {
        setAuth(ok);
    }); }, []);
        ...
        React.createElement(BrowserRouter, null,
            React.createElement(Suspense, { fallback: React.createElement(SplashScreen, null) },
                React.createElement(Routes, null,
                    React.createElement(Route, { path: "/", element: !auth ? React.createElement(Start, null) : React.createElement(Navigate, { to: "/inicio" }) }),
                    React.createElement(Route, { path: "/ingresar", element: !auth ? React.createElement(Login, null) : React.createElement(Navigate, { to: "/inicio" }) }),
                    React.createElement(Route, { path: "/inicio/*", element: !auth ? React.createElement(Home, null) : React.createElement(Navigate, { to: "/ingresar" }) }),
                    React.createElement(Route, { path: "/cuenta", element: !auth ? React.createElement(Account, null) : React.createElement(Navigate, { to: "/ingresar" }) }),
                    React.createElement(Route, { path: "/registrarse", element: React.createElement(SignUp, null) }),
