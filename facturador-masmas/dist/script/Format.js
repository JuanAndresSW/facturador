        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        data = _b.apply(_a, [(_e.user = (_f.avatar = _g.sent(),
                                _f),
                                _e.trader = {
                                    businessName: account.trader.businessName.trim(),
                                    vatCategory: account.trader.vatCategory,
                                    code: (c.length !== 0) ? c.slice(0, 2) + '-' + c.slice(2, 4) + '.' + c.slice(4, 7) + '.' + c.slice(7, 10) + '-' + c.charAt(10) : '',
                                    grossIncome: (g.length !== 0) ? g.slice(0, 2) + '-' + g.slice(2, 4) + '.' + g.slice(4, 7) + '.' + g.slice(7, 10) + '-' + g.charAt(10) : '',
                                },
                                _e)]);
                        _d = (_c = console).log;
                        return [4 /*yield*/, account.user.avatar.text()];
                    case 2:
                        _d.apply(_c, [(_g.sent()).length]);
